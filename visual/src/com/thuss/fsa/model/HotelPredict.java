...
/**
 * HotelPredict entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "hotel_predict", schema = "dbo", catalog = "hotel")
public class HotelPredict implements java.io.Serializable {
	...
	/** minimal constructor */
	public HotelPredict(Long id) {
		this.id = id;
	}

	/** full constructor */
	public HotelPredict(Long id, Long hotelId, Integer version, Date theDate,
