    ...
    <div class="container">
        ...
        <c:choose>
            <c:when test="${page.list eq null}">
                    <div id="content">
                        <p style="margin-top: 20px;margin-left: 30px;">The content you searched for does not exist, please re-enter.</p>
                    </div>
            </c:when>
            <c:otherwise>
		        <div class="row">
		            ...
		            <table id="hotel_table" class="table table-striped table-hover">
		               ...
		               <c:forEach items="${page.list}" var="food">
		                    ...
		                    <td>${food.totalNum}</td>
		                    <td>
		                        <a href="foodInfo.do?foodId=${food.foodId}" type="button" class="btn btn-default btn-primary">Details</a>
		                    </td>
		               	 	</tr>
		               </c:forEach>
		            </table>
